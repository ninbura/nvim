...
4. ### git clone this repository
    - #### as the primary configuration
        ...
        - ```powershell
          # ssh
          git clone git@github.com:ninbura/nvim.git --config name=ninbura --config email=gabriel@ninbura.com
          ```
    - #### as an additional configuration
        ...
        - ```powershell
          # ssh
          git clone git@github.com:ninbura/nvim.git ninvim --config name=ninbura --config email=gabriel@ninbura.com
          ```
